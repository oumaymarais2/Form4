...
namespace Form4 {
    ...
    public partial class BooksDataSet : global::System.Data.DataSet {
        ...
        public partial class LibraryDataTable : global::System.Data.TypedTableBase<LibraryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public LibraryRow AddLibraryRow(string Name, int Price) {
        ...
        public partial class LibraryRow : global::System.Data.DataRow {
            ...
            public int Price {
                get {
                    try {
                        return ((int)(this[this.tableLibrary.PriceColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace Form4.BooksDataSetTableAdapters {
    ...
    public partial class LibraryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Library] WHERE (([ID] = @Original_ID) AND ((@IsNull_Name = 1 A" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Library] ([Name], [Price]) VALUES (@Name, @Price);\r\nSELECT ID," +
                " Name, Price FROM Library WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Library] SET [Name] = @Name, [Price] = @Price WHERE (([ID] = @Original_ID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)));
SELECT ID, Name, Price FROM Library WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Form4.Properties.Settings.Default.BooksConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Price FROM dbo.Library";
        ...
        public virtual int Fill(BooksDataSet.LibraryDataTable dataTable) {
        ...
        public virtual BooksDataSet.LibraryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BooksDataSet.LibraryDataTable dataTable = new BooksDataSet.LibraryDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BooksDataSet.LibraryDataTable dataTable) {
