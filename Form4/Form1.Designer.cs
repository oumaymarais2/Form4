namespace Form4
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.booksDataSet = new Form4.BooksDataSet();
			this.libraryBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.libraryTableAdapter = new Form4.BooksDataSetTableAdapters.LibraryTableAdapter();
			...
			this.button3.Location = new System.Drawing.Point(377, 202);
			...
			this.libraryBindingSource.DataSource = this.booksDataSet;
			// 
			// libraryTableAdapter
			// 
		...
		private BooksDataSetTableAdapters.LibraryTableAdapter libraryTableAdapter;
	}
}
